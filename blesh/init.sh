...
bleopt vbell_duration=
bleopt vbell_align=
ble-face vbell=none
ble-face vbell_erase=none
ble-face vbell_flash=none
...
bleopt edit_magic_accept=verify
...
bleopt history_default_point=near
...
ble-face menu_filter_fixed=fg=#908caa,bold
ble-face menu_filter_input=fg=#e0def4,bold
...
bleopt complete_limit_auto_menu=50
...
ble-face menu_desc_default=fg=#6e6a86 # Без bold для описаний
ble-face menu_desc_type=fg=#3e8fb0,bold
ble-face menu_desc_quote=fg=#ea9a97,bold
...
ble-face region=fg=#e0def4,bg=#393552,bold
ble-face region_insert=fg=#9ccfd8,bold
ble-face region_match=fg=#f6c177,bold
ble-face region_target=fg=#ea9a97,bold
ble-face disabled=fg=#6e6a86
ble-face overwrite_mode=fg=#232136,bg=#9ccfd8,bold
...
ble-face syntax_param_expansion=fg=#ea9a97,bold
ble-face syntax_history_expansion=fg=#e0def4,bg=#393552,bold
ble-face syntax_function_name=fg=#c4a7e7,bold
ble-face syntax_comment=fg=#6e6a86
ble-face syntax_varname=fg=#eb6f92,bold
ble-face syntax_delimiter=fg=#908caa,bold
ble-face syntax_glob=fg=#f6c177,bold
ble-face syntax_brace=fg=#c4a7e7,bold
ble-face syntax_tilde=fg=#3e8fb0,bold
ble-face syntax_document=fg=#9ccfd8,bold
ble-face syntax_document_begin=fg=#9ccfd8,bold

ble-face command_builtin=fg=#f6c177,bold
ble-face command_builtin_dot=fg=#eb6f92,bold
ble-face command_alias=fg=#3e8fb0,bold
ble-face command_function=fg=#c4a7e7,bold
ble-face command_file=fg=#9ccfd8,bold
ble-face command_keyword=fg=#ea9a97,bold
ble-face command_jobs=fg=#eb6f92,bold
ble-face -s command_directory          fg=63
...
ble-face -s filename_directory         fg=33
ble-face -s filename_directory_sticky  fg=231,bg=26
ble-face -s filename_link              fg=teal
ble-face -s filename_orphan            fg=16,bg=224
...
ble-face -s filename_character         fg=231,bg=black
...
ble-face varname_empty=fg=#6e6a86
ble-face varname_export=fg=#eb6f92,bold
ble-face varname_expr=fg=#c4a7e7,bold
ble-face varname_hash=fg=#9ccfd8,bold
ble-face varname_new=fg=#3e8fb0,bold
ble-face varname_number=fg=#908caa,bold
ble-face varname_readonly=fg=#eb6f92,bold
ble-face varname_transform=fg=#3e8fb0,bold
ble-face varname_unset=fg=#6e6a86

ble-face cmdinfo_cd_cdpath=fg=#9ccfd8,bg=#2a283e,bold
##-----------------------------------------------------------------------------
## Keybindings
